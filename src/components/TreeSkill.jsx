  ...
  return (
    <div className="grid  md:grid-cols-2 gap-10 justify-items-center my-12">
      <div className=" border rounded-full p-14">
        <div className="border  p-16  shadow-2xl shadow-gray-400 rounded-full rotate-180 md:-rotate-90  w-76 h-76 ">
          <div className="border bg-gray-200 p-16  shadow-2xl rounded-full w-full h-full">
            <div className="border p-16  shadow-2xl  rounded-full w-full h-full bg-gradient-to-tl from-white to-gray-200">
              <div
      ...
      <div className="border rounded-full p-14">
        <div className="border  p-16  shadow-2xl shadow-gray-400 rounded-full -rotate-90 md:rotate-45  w-76 h-76 ">
          <div className="border bg-gray-200 p-16  shadow-2xl rounded-full w-full h-full">
            <div className="border p-16  shadow-2xl  rounded-full w-full h-full bg-gradient-to-tl from-white to-gray-200">
              <div
                className="border-2 bg-white p-14 rounded-full w-full h-full flex justify-center items-center "
      ...
      <div className="border rounded-full p-14 md:col-span-2">
        <div className="border-2  p-16  shadow-2xl shadow-gray-400 rounded-full rotate-180 md:rotate-[150deg] w-76 h-76  ">
          <div className="border bg-gray-200 p-16  shadow-2xl rounded-full w-full h-full">
            <div className="border p-16  shadow-2xl  rounded-full w-full h-full bg-gradient-to-tl from-white to-gray-200">
              <div
