...
const Projects = () => {
  ...
  return (
    <section className="bg-white md:py-10 py-5 ">
      ...
      <div className="  mx-auto">
        {projects.map((project) => (
          <div
            key={project.id}
            className="bg-gray-100 rounded-xl shadow p-4 hover:shadow-lg border-4 border-[#98CD00] transition  my-5 flex flex-col md:flex-row gap-5 "
          >
            <img
              src={project.image}
              alt={project.name}
              className="rounded-lg md:w-1/2 h-56 object-cover mb-4"
            />
